...
| 전남 포털 빠른 확인 | `의무연수 1`·`의무연수 2` 항목만 바로 모아보고 전남교육연수포털을 새 창으로 열 수 있습니다. |
| 수료증 찾기 정보 | 각 연수에 수료증 파일명과 내 컴퓨터의 보관 위치를 기록하고 검색할 수 있습니다. 실제 파일은 웹사이트에 올리지 않습니다. |
...
| 백업과 출력 | 전체 연도 JSON 백업, 연도별 CSV 표 파일, A4 인쇄·PDF 저장을 지원합니다. 백업을 불러올 때는 현재 기록을 먼저 내려받아 실수로 덮어쓰는 일을 줄입니다. |
...
5. 전남교육연수포털 묶음 과정은 **의무연수 1** 또는 **의무연수 2**를 눌러 빠르게 확인합니다.
6. 연수 수정 화면의 **수료증 기록**에서 파일명과 보관 위치를 적습니다.
7. 개인 연수는 **연수 추가**를 눌러 직접 등록합니다.
8. 여러 기기에서 같은 기록을 쓰려면 [계정 동기화 버전](https://yeonsudam-teacher-training.rn-act.chatgpt.site/)을 엽니다.
9. **데이터 관리 → 전체 연도 백업**을 눌러 백업 파일을 정기적으로 보관합니다.
...
- 학생 이름, 상담 내용, 연락처, 건강정보, 생활기록부 내용 등 **학생 개인정보를 연수명·메모·수료증 파일명·보관 위치에 입력하지 마세요.**
...
- [ ] 수료증 파일명과 보관 위치에 학생 개인정보가 들어 있지 않습니다.
